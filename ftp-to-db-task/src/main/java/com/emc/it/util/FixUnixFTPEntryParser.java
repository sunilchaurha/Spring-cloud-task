 ...
 * Unix Systems.
 * <p>
 * <b>Identical to {@link UnixFTPEntryParser} except it does not strip leading
 * spaces from the file name</b>.
 * <p>
 ...
 */
public class FixUnixFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
     ...
     * @since 1.4
     */
    public FixUnixFTPEntryParser(FTPClientConfig config)
    {
        super(REGEX);
        configure(config);
    }
